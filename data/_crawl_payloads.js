module.exports = {
  payloads: [
      ...
      payloads: [
        {
          ...
          "q": "a.entry-title-link",
          "pg_url": "https://www.ribbonfarm.com/page/$replace/",
          "pg_q": "li.pagination-next a",
          "pg_count": 100
        },
    ...
    },
    {
      ...
      payloads: [
        {
          url: "https://ptimofeev.com/",
          q: "article.post a.read-more",
    ...
    },
    {
      ...
      payloads: [
        {
          url: "https://mjtsai.com/blog/archives/",
          q: "#main li a",
    ...
    },
    {
      ...
      payloads: [
        {
          url: "https://microkerneldude.wordpress.com/",
          q: ".post-header h2 a",
    ...
    },
    {
      ...
      payloads: [
        {
          url: "https://habd.as/post/",
          q: "article header h1 a",
    ...
    },
    {
      ...
      payloads: [
        {
          url: "https://limitedresults.com/posts/",
          q: ".entry-title a",
    ...
    },
    {
      ...
      payloads: [
        {
          url: "https://coding.napolux.com/",
          q: ".loop__post-title a",
    ...
    },
    {
      ...
      payloads: [
        {
          url: "https://cheapskatesguide.org/",
          q: ".articles-list .read-more",
    ...
    },
    {
      ...
      payloads: [
        {
          url: "https://canion.me/",
          q: ".entry .small.date.left.margin",
      ...
      payloads: [
        {
          ...
          q: ".entry-title a",
          pg_url: "https://stratechery.com/category/articles/page/$replace/",
          pg_count: 41
        },
        {
    ...
    },
    {
      ...
      payloads: [
        {
          url: "https://joshwcomeau.com/latest/",
          q: "article a"
        },
        {
    ...
    // },
    // {
    //   root: "https://www.giftegwuenu.com/",
    //   payloads: [
    //     {
    //       url: ".post-card a",
    //       q: "li a"
    ...
    // },
    // {
    //   root: "https://jethro.dev/",
    //   payloads: [
    //     {
    //       url: "https://blog.jethro.dev/",
    //       q: "article a"
    //     },
    //     {
    ...
    // },
    // {
    //   root: "https://www.drmaciver.com/blog/",
    //   payloads: [
    //     {
    //       url: "https://www.drmaciver.com/blog/",
    //       q: "",
    //       pg_url: "https://www.drmaciver.com/blog/page/$replace/",
    //       pg_count: 187
    //     }
    //   ]
    // },
    // {
    //   root: "http://troubles.md/",
    //   payloads: [
    //     {
    ...
    // },
    // {
    //   root: "https://ncona.com/",
    //   payloads: [
    //     {
    //       url: "https://ncona.com/",
    //       q: ".post h1 a",
    //       pg_url: "https://ncona.com/page$replace/",
    //       pg_count: 37
    //     }
    //   ]
    // },
    // {
    //   root: "https://sarahdrasnerdesign.com/",
    //   payloads: [
    //     {
    ...
    // },
    // {
    //   root: "https://blog.frenco.dev/",
    //   payloads: [
    //     {
    //       url: "https://blog.frenco.dev/",
    //       q: ".Feed-module--feed__item-title-link--iFMRs"
    //     }
    //   ]
    // },
    // {
    //   root: "https://unknwon.io/",
    //   payloads: [
    //     {
    //       url: "https://unknwon.io/posts/",
    //       q: "a.title"
    //     }
    //   ]
    // },
    // {
    //   root: "https://mdswanson.com/",
    //   payloads: [
    //     {
    //       url: "https://mdswanson.com/archive/",
    //       q: "#archive li a"
    //     }
    //   ]
    // },
    // {
    //   root: "https://sarahmhigley.com",
    //   payloads: [
    //     {
    //       url: "https://sarahmhigley.com/writing/",
    //       q: "a.h3"
    //     }
    //   ]
    // },
    // {
    //   root: "https://www.24a11y.com/",
    //   payloads: [
    //     {
    ...
    // },
    // {
    //   root: "https://adrianroselli.com/",
    //   payloads: [
    //     {
    //       url: "https://adrianroselli.com/",
    //       q: "article h2 a",
    //       pg_url: "https://adrianroselli.com/page/$replace",
    //       pg_count: 53
    //     }
    //   ]
    // },
    // {
    //   root: "https://blog.jim-nielsen.com/",
    //   payloads: [
    //     {
    ...
    // },
    // {
    //   root: "https://piccalil.li",
    //   payloads: [
    //     {
    //       url: "https://piccalil.li/tutorials/0/",
    //       q: ".auto-grid li a",
    //       pg_url: "https://piccalil.li/tutorials/$replace/",
    //       pg_count: 1
    //     },
    //     {
    //       url: "https://piccalil.li/quick-tips/0/",
    //       q: ".auto-grid li a",
    //       pg_url: "https://piccalil.li/quick-tips/$replace/",
    //       pg_count: 1
    //     },
    //     {
    //       url: "https://piccalil.li/blog/0/",
    //       q: ".auto-grid li a",
    //       pg_url: "https://piccalil.li/blog/$replace/",
    //       pg_count: 1
    //     },
    //   ]
    // },
    // {
    //   root: "https://fossheim.io/",
    //   payloads: [
    //     {
    //       url: "https://fossheim.io/writing/archive/",
    //       q: ".posts-list-item a",
    //       pg_url: "",
    //       pg_count: 0
    //     }
    ...
    // },
    // {
    //   root: "https://sites.google.com/",
    //   payloads: [
    //     {
    //       url: "https://sites.google.com/site/steveyegge2/blog-rants",
    //       q: ".sites-layout-tile.sites-tile-name-content-1.sites-canvas-sidebar a"
    //     }
    //   ]
    // },
    // {
    //   root: "https://www.jwz.org/",
    //   payloads: [
    //     {
    //       url: "https://www.jwz.org/doc/",
    //       q: ".item a"
    //     },
    //     {
    //       url: "https://www.jwz.org/doc/",
    //       q: ".entry-title a",
    //       pg_url: "https://www.jwz.org/blog/page/$replace/",
    //       pg_count: 1094
    //     }
    //   ]
    // },
    // {
    //   root: "https://danluu.com/",
    //   payloads: [
    //     {
    ...
    // },
    // {
    //   root: "https://randomascii.wordpress.com/",
    //   payloads: [
    //     {
    //       url: "https://randomascii.wordpress.com/",
    //       q: ".entry-title a",
    //       pg_url: "https://randomascii.wordpress.com/page/$replace/",
    //       pg_count: 22
    //     }
    //   ]
    // },
    // {
    //   root: "https://huyenchip.com/",
    //   payloads: [
    //     {
    ...
    //     },
    //     {
    //       url: "https://huyenchip.com/stories/",
    //       q: ".post-content a"
    //     }
    //   ]
    // },
    // {
    //   root: "http://www.chrisfenton.com/",
    //   payloads: [
    //     {
    //       url: "http://www.chrisfenton.com/",
    //       q: ".entry-title a",
    //       pg_url: "http://www.chrisfenton.com/page/$replace/",
    //       pg_count: 3
    //     }
    //   ]
    // },
    // {
    //   root: "https://mcfunley.com/",
    //   payloads: [
    //     {
    //       url: "https://mcfunley.com/writing",
    //       q: "article a"
    //     },
    //     {
    //       url: "https://mcfunley.com/writing",
    ...
    // },
    // {
    //   root: "https://eli.thegreenplace.net/",
    //   payloads: [
    //     {
    //       url: "https://eli.thegreenplace.net/tag/articles",
    //       q: "#content tr td a"
    //     }
    //   ]
    // },
    // {
    //   root: "https://www.evanjones.ca/",
    //   payloads: [
    //     {
    //       url: "https://www.evanjones.ca/chronological.html",
    //       q: "ul li a"
    //     }
    //   ]
    // },
    // {
    //   root: "https://fgiesen.wordpress.com/",
    //   payloads: [
    //     {
    //       url: "https://fgiesen.wordpress.com/",
    //       q: ".date a",
    //       pg_url: "https://fgiesen.wordpress.com/page/replace/",
    //       pg_count: 15
    //     }
    //   ]
    // },
